...
machineGraph CounterLoop @id("machine_graph_counter_loop") {
  ...
  branch loopBack @id("branch_loop_back") instruction instruction_bne from instruction_bne to label_loop kind conditional condition "Z == 0" flag flag_zero proofStatus missing reasonCode machine-branch-target-proof-missing evidence evidence_counter_trace
